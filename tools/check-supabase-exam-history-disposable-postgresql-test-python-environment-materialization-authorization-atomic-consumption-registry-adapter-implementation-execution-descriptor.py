...
contract = load_json(CONTRACT, "v27.33o-Vertrag")
source = load_json(SOURCE, "v27.33n-Quellvertrag")
module = load_module(MODULE, "v2733o_execution_descriptor")
...
if contract.get("version") != "v27.33o":
    fail("Descriptorvertrag besitzt nicht v27.33o.")
...
if source.get("version") != "v27.33n":
    fail("Quellvertrag besitzt nicht v27.33n.")
...
if implementation.get("executionDescriptorImplemented") is not True:
    fail("Implementierungsausführungsdescriptor fehlt.")
...
if descriptor.get("sourceContractVersion") != "v27.33n":
...
if descriptor.get("executionGrant") is not False:
    fail("Descriptor öffnet den Grant.")
...
if FUTURE_GUARD.exists():
    fail("v27.33o darf noch keinen Descriptor-Annahme-Guard umsetzen.")
if FUTURE_ADAPTER.exists():
    fail("v27.33o darf noch keinen Registry-Adapter implementieren.")
if FUTURE_EXECUTION.exists():
    fail("v27.33o darf noch keine Adapter-Ausführung umsetzen.")
if list(MIGRATIONS.glob("*v2733o*.sql")):
    fail("v27.33o darf keine SQL-Migration erzeugen.")

print("Registry-Adapter-Implementierungsausführungsdescriptor: OK")
print("Quellvertrag: v27.33n")
...
print("SQL-Migration v27.33o: keine")
