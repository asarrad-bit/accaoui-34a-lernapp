...
- Verbindlicher Projektzustand: `docs/PROJECT_STATE_CURRENT.md`
- Verbindliche Task-Steuerung: `docs/tasks/CURRENT_TASK.md`
- `CURRENT_TASK` ist aktuell `AUTHORIZED` für `v27.35d`
...
Diese Bestands- und Backlogliste ist keine Task-Autorisierung. Ein funktionaler Task darf ausschließlich durch den Projekteigentümer und den verbindlichen Projektchat ausgewählt und in `docs/tasks/CURRENT_TASK.md` ausdrücklich autorisiert werden. `CURRENT_TASK` ist aktuell `AUTHORIZED` für `v27.35d`; aus dieser Liste ist kein weiterer Folgeschritt ausgewählt oder autorisiert. Backlog-Kandidaten B (schriftliche Prüfungs-Regression) und C (Quellen/mündliche Musterfragen) sind nicht autorisiert.
