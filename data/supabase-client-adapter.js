...
(function () {
  ...
  function getParticipantDashboardExamHistoryDataSourceState() {
    ...
    return {
      ...
      snapshotPersistenceCycleRegistryResultContractName:
        "mapParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryResultContract",
      isSnapshotPersistenceCycleRegistryResultContractPrepared: true,
      canMapSnapshotPersistenceCycleRegistryResults: true,
      initialSnapshotPersistenceCycleRegistryResultState: null,
      ...
      initialSnapshotPersistenceCycleRegistryResultAcceptanceState: null,
      ...
      initialSnapshotPersistenceCycleRegistryCompletionState: null,
      snapshotPersistenceCycleRegistryCycleMapperName:
  ...
  function getParticipantDashboardExamHistoryState() {
    ...
    return {
      ...
      dataSourceSnapshotPersistenceCycleRegistryResultContractName: participantDashboardExamHistoryDataSourceState.snapshotPersistenceCycleRegistryResultContractName,
      isDataSourceSnapshotPersistenceCycleRegistryResultContractPrepared: participantDashboardExamHistoryDataSourceState.isSnapshotPersistenceCycleRegistryResultContractPrepared === true,
      canMapDataSourceSnapshotPersistenceCycleRegistryResults: participantDashboardExamHistoryDataSourceState.canMapSnapshotPersistenceCycleRegistryResults === true,
      dataSourceInitialSnapshotPersistenceCycleRegistryResultState: participantDashboardExamHistoryDataSourceState.initialSnapshotPersistenceCycleRegistryResultState,
      dataSourceSnapshotPersistenceCycleRegistryResultAcceptanceGuardName: participantDashboardExamHistoryDataSourceState.snapshotPersistenceCycleRegistryResultAcceptanceGuardName,
      isDataSourceSnapshotPersistenceCycleRegistryResultAcceptanceGuardPrepared: participantDashboardExamHistoryDataSourceState.isSnapshotPersistenceCycleRegistryResultAcceptanceGuardPrepared === true,
      canGuardDataSourceSnapshotPersistenceCycleRegistryResultAcceptance: participantDashboardExamHistoryDataSourceState.canGuardSnapshotPersistenceCycleRegistryResultAcceptance === true,
      dataSourceInitialSnapshotPersistenceCycleRegistryResultAcceptanceState: participantDashboardExamHistoryDataSourceState.initialSnapshotPersistenceCycleRegistryResultAcceptanceState,
      dataSourceSnapshotPersistenceCycleRegistryCompletionMapperName: participantDashboardExamHistoryDataSourceState.snapshotPersistenceCycleRegistryCompletionMapperName,
      isDataSourceSnapshotPersistenceCycleRegistryCompletionMapperPrepared: participantDashboardExamHistoryDataSourceState.isSnapshotPersistenceCycleRegistryCompletionMapperPrepared === true,
      canMapDataSourceSnapshotPersistenceCycleRegistryCompletionStates: participantDashboardExamHistoryDataSourceState.canMapSnapshotPersistenceCycleRegistryCompletionStates === true,
      dataSourceInitialSnapshotPersistenceCycleRegistryCompletionState: participantDashboardExamHistoryDataSourceState.initialSnapshotPersistenceCycleRegistryCompletionState,
      dataSourceSnapshotPersistenceCycleRegistryCycleMapperName: participantDashboardExamHistoryDataSourceState.snapshotPersistenceCycleRegistryCycleMapperName,
  ...
  function mapParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryCycleState(input) {
      ...
      try {
        ...
        for (
          ...
          if (
            ...
            if (
              !candidateSerialization.isValid ||
              !canonicalSerialization.isValid ||
              candidateSerialization.canSerializeRegistry !==
                true ||
              canonicalSerialization.canSerializeRegistry !==
                true ||
              candidateSerialization.serializedJson !==
                canonicalSerialization.serializedJson ||
              candidateSerialization.serializedByteLength !==
                canonicalSerialization.serializedByteLength
            ) {
              return false;
            }
    ...
    const createState = ({
      ...
      resultContractIdentity = null,
      resultAcceptanceIdentity = null,
      ...
      status,
      isValid,
      isSnapshotPersistenceCycleRegistryCycleMapperOnly: true,
      isLiveCall: false,
      canFinalizeCycle,
      isTerminal,
      isSuccessful,
    ...
    const invalid = (reason) =>
      createState({
        status:
          "exam_result_history_persistence_cycle_registry_cycle_invalid",
        isValid: false,
    ...
    if (!packageProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_cycle_invocation_package_missing"
      );
    }

    if (!packageProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_cycle_invocation_package_accessor_not_allowed"
      );
    }

    if (!resultProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_cycle_result_contract_missing"
      );
    }

    if (!resultProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_cycle_result_contract_accessor_not_allowed"
      );
    }

    if (!acceptanceProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_cycle_acceptance_missing"
      );
    }

    if (!acceptanceProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_cycle_acceptance_accessor_not_allowed"
      );
    }

    if (!completionProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_cycle_completion_missing"
      );
    }

    if (!completionProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_cycle_completion_accessor_not_allowed"
      );
    }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_cycle_recomputed_acceptance_not_ready"
      );
    }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_cycle_acceptance_state_mismatch"
      );
    }

    const completionFromProvidedAcceptance =
      mapParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryCompletionState({
        acceptanceState
      });
    ...
    if (
      !completionFromProvidedAcceptance.isValid ||
      completionFromProvidedAcceptance.canFinalizePersistence !==
        true ||
      completionFromProvidedAcceptance.isTerminal !==
        true ||
      completionFromProvidedAcceptance.isSuccessful !==
        true ||
      completionFromProvidedAcceptance.canExecuteStorage !==
        false
    ) {
      return invalid(
        "persistence_cycle_registry_cycle_provided_completion_invalid"
      );
    }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_cycle_recomputed_completion_invalid"
      );
    }

    if (
      !compareCanonicalState(
        completionFromProvidedAcceptance,
      ...
      return invalid(
        "persistence_cycle_registry_cycle_completion_state_mismatch"
      );
    }

    if (
      recomputedCompletion.activeInvocationPackageIdentity !==
        recomputedAcceptance.activeInvocationPackageIdentity ||
      recomputedCompletion.resultInvocationPackageIdentity !==
        recomputedAcceptance.resultInvocationPackageIdentity ||
      recomputedCompletion.resultStatus !==
        recomputedAcceptance.resultStatus ||
      recomputedCompletion.intent !==
        recomputedAcceptance.intent ||
      recomputedCompletion.operation !==
        recomputedAcceptance.operation ||
      recomputedCompletion.methodName !==
        recomputedAcceptance.methodName ||
      recomputedCompletion.requiredCapability !==
        recomputedAcceptance.requiredCapability ||
      recomputedCompletion.readinessFingerprint !==
        recomputedAcceptance.readinessFingerprint ||
      recomputedCompletion.storageNamespace !==
        storageNamespace ||
      recomputedCompletion.storageKey !==
        storageKey ||
      recomputedCompletion.registryIdentity !==
        registryIdentity
    ) {
      return invalid(
        "persistence_cycle_registry_cycle_context_mismatch"
      );
    }
    ...
    return createState({
      ...
      isSuccessful: true,
      canUseRegistry:
        recomputedCompletion.canUseRegistry ===
          true,
      intent:
        recomputedCompletion.intent,
      operation:
      ...
      contractIdentity:
        recomputedCompletion.contractIdentity,
      operationPlanIdentity:
        recomputedCompletion.operationPlanIdentity,
      operationReleaseIdentity:
        recomputedCompletion.operationReleaseIdentity,
      executionGuardIdentity:
        recomputedCompletion.executionGuardIdentity,
      invocationContractIdentity:
        recomputedCompletion.invocationContractIdentity,
      resultContractIdentity:
        recomputedCompletion.resultContractIdentity,
      resultAcceptanceIdentity:
        recomputedCompletion.resultAcceptanceIdentity,
      completionIdentity:
      ...
      resultKind:
        recomputedCompletion.resultKind,
      didRead:
      ...
      completedCycleCount:
        recomputedCompletion.completedCycleCount,
      serializedByteLength:
        recomputedCompletion.serializedByteLength,
      registryPayload:
        recomputedCompletion.registryPayload,
      registryState:
        recomputedCompletion.registryState,
      reason: null
    });
  }
  ...
  function mapParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryCompletionState(input) {
    ...
    if (!acceptanceProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_completion_acceptance_accessor_not_allowed"
      );
    }
    ...
    const fieldsState =
      readRequiredFields(
        ...
        [
          "status",
          "isValid",
          "isSnapshotPersistenceCycleRegistryResultAcceptanceGuardOnly",
          "isLiveCall",
          "canApplyResult",
          "didAcceptResult",
          "isStaleResult",
    ...
    if (!fieldsState.isValid) {
      return invalid(
        "persistence_cycle_registry_completion_acceptance_fields_invalid"
      );
    }
    ...
    if (
      ...
      fields.status !==
        "exam_result_history_persistence_cycle_registry_result_acceptance_ready" ||
      fields.isValid !== true ||
      fields.isSnapshotPersistenceCycleRegistryResultAcceptanceGuardOnly !==
        true ||
      fields.isLiveCall !== false ||
      fields.canApplyResult !== true ||
      fields.didAcceptResult !== true ||
      fields.isStaleResult !== false ||
      fields.canExecuteStorage !==
        false ||
      fields.acceptanceGuardVersion !==
        1 ||
      fields.maximumResultBytes !==
        maximumResultBytes ||
      fields.maximumCompletedCycleIdentities !==
    ...
    if (
      fields.activeInvocationPackageIdentity !==
        expectedPackageIdentity ||
      fields.resultInvocationPackageIdentity !==
        expectedPackageIdentity ||
      fields.activeInvocationPackageIdentity !==
        fields.resultInvocationPackageIdentity ||
      fields.contractIdentity !==
    ...
    if (fields.intent === "load") {
      if (
        fields.resultStatus ===
          "exam_result_history_persistence_cycle_registry_result_read_empty"
      ) {
        if (
          fields.canUseRegistry !==
            false ||
          fields.didRead !== true ||
          fields.didWrite !== false ||
          fields.didDelete !== false ||
      ...
      if (
        ...
        deserializationState.serializedByteLength !==
          fields.serializedByteLength ||
        JSON.stringify(
          deserializationState.registryPayload
        ) !==
          JSON.stringify(
            fields.registryPayload
          )
      ...
      return completed(
        ...
        "read_ready",
        {
          ...
          registryPayload:
            deserializationState.registryPayload,
          registryState:
            deserializationState.registryState
        }
      );
    }
  ...
  function guardParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryResultAcceptance(input) {
    ...
    const cloneRegistryPayload = (
      ...
      try {
        ...
        if (
          !identitiesState.isValid ||
          identitiesState.values.length >
            maximumCompletedCycleIdentities
        ) {
          return {
            isValid: false,
    ...
    if (!packageProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_package_accessor_not_allowed"
      );
    }
    ...
    const packageFieldsState =
      readRequiredFields(
        activePackage,
        [
          "status",
          "isValid",
          "isSnapshotPersistenceCycleRegistryInvocationPackageOnly",
          "isLiveCall",
          "canInvokeLater",
    ...
    if (!packageFieldsState.isValid) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_package_fields_invalid"
      );
    }

    const packageFields =
      packageFieldsState.fields;
    ...
    const packageConfig =
      intentConfig[
        packageFields.intent
      ];

    if (
      !packageConfig ||
      packageFields.status !==
        "exam_result_history_persistence_cycle_registry_invocation_package_ready" ||
      packageFields.isValid !== true ||
      packageFields.isSnapshotPersistenceCycleRegistryInvocationPackageOnly !==
        true ||
      packageFields.isLiveCall !==
        false ||
      packageFields.canInvokeLater !==
        true ||
      packageFields.isInvocationPackageValidated !==
        true ||
      packageFields.isCapabilityAvailable !==
        true ||
      packageFields.isMethodReferenceValidated !==
        true ||
      packageFields.canExecuteStorage !==
        false ||
      packageFields.invocationPackageVersion !==
        1 ||
      packageFields.operation !==
        packageConfig.operation ||
      packageFields.methodName !==
        packageConfig.methodName ||
      packageFields.requiredCapability !==
        packageConfig.requiredCapability ||
      packageFields.storageNamespace !==
        storageNamespace ||
      packageFields.storageKey !==
        storageKey ||
      packageFields.registryIdentity !==
        registryIdentity ||
      packageFields.maximumSerializedBytes !==
        maximumResultBytes ||
      packageFields.maximumCompletedCycleIdentities !==
        maximumCompletedCycleIdentities ||
      packageFields.reason !== null
    ) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_package_invalid"
      );
    ...
    const expectedPackageFlags = {
      save:
        packageFields.intent === "save",
      load:
        packageFields.intent === "load",
      delete:
        packageFields.intent === "delete"
    };

    if (
      packageFields.canPackageSave !==
        expectedPackageFlags.save ||
      packageFields.canPackageLoad !==
        expectedPackageFlags.load ||
      packageFields.canPackageDelete !==
        expectedPackageFlags.delete
    ) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_package_flags_invalid"
      );
    }

    if (
      packageFields.contractIdentity !==
        (
          "exam_history_persistence_cycle_registry_contract:" +
          packageFields.intent +
          ":v1"
        ) ||
      packageFields.operationPlanIdentity !==
        (
          "exam_history_persistence_cycle_registry_operation_plan:" +
          packageFields.intent +
          ":v1"
        ) ||
      packageFields.operationReleaseIdentity !==
        (
          "exam_history_persistence_cycle_registry_operation_release:" +
          packageFields.intent +
          ":v1"
        ) ||
      packageFields.executionGuardIdentity !==
        (
          "exam_history_persistence_cycle_registry_execution_guard:" +
          packageFields.intent +
          ":v1"
        ) ||
      packageFields.invocationContractIdentity !==
        (
          "exam_history_persistence_cycle_registry_invocation_contract:" +
          packageFields.intent +
          ":v1"
        ) ||
      packageFields.invocationPackageIdentity !==
        (
          "exam_history_persistence_cycle_registry_invocation_package:" +
          packageFields.intent +
          ":v1"
    ...
    const packageReadinessMatch =
      /^exam_history_persistence_cycle_registry_storage_adapter_readiness:v1:read=([01]):write=([01]):delete=([01])$/.exec(
        packageFields.readinessFingerprint
      );

    if (!packageReadinessMatch) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_readiness_invalid"
      );
    }

    const packageCapabilityState = {
      read:
        packageReadinessMatch[1] ===
        "1",
      write:
        packageReadinessMatch[2] ===
        "1",
      delete:
        packageReadinessMatch[3] ===
        "1"
    };
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_capability_invalid"
      );
    }

    const packageArgumentsState =
      cloneStringArray(
        packageFields.invocationArguments
      );

    if (
      !packageArgumentsState.isValid ||
      !Number.isInteger(
        packageFields.invocationArgumentCount
      ) ||
      packageFields.invocationArgumentCount !==
        packageConfig.argumentCount ||
      packageFields.invocationArgumentCount !==
        packageArgumentsState.values.length
    ) {
      return invalid(
    ...
    let activeCompletedCycleCount =
      null;

    let activeSerializedByteLength =
      null;

    let activeSerializedJson =
      null;

    if (packageFields.intent === "save") {
      if (
        !Number.isInteger(
          packageFields.completedCycleCount
        ) ||
        packageFields.completedCycleCount <
          0 ||
        packageFields.completedCycleCount >
          maximumCompletedCycleIdentities ||
        !Number.isSafeInteger(
          packageFields.serializedByteLength
        ) ||
        packageFields.serializedByteLength <
          1 ||
        packageFields.serializedByteLength >
          maximumResultBytes ||
        typeof packageFields.serializedJson !==
          "string"
      ) {
        return invalid(
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_acceptance_active_save_size_mismatch"
        );
      }
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_acceptance_active_save_round_trip_invalid"
        );
      }

      activeCompletedCycleCount =
        packageFields.completedCycleCount;

      activeSerializedByteLength =
        actualByteLength;

      activeSerializedJson =
        packageFields.serializedJson;
    } else if (
      packageFields.completedCycleCount !==
        null ||
      ...
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_payload_unexpected"
      );
    }

    const expectedPackageArguments =
      packageFields.intent === "save"
        ? [
            storageKey,
            activeSerializedJson
    ...
    if (
      JSON.stringify(
        packageArgumentsState.values
      ) !==
      JSON.stringify(
        expectedPackageArguments
      )
    ) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_active_arguments_invalid"
    ...
    const resultFieldsState =
      readRequiredFields(
        resultState,
        [
          "status",
          "isValid",
          "isSnapshotPersistenceCycleRegistryResultContractOnly",
          "isLiveCall",
          "canAcceptResult",
          "canUseRegistry",
          "canExecuteStorage",
    ...
    if (!resultFieldsState.isValid) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_result_fields_invalid"
      );
    }

    const resultFields =
      resultFieldsState.fields;
    ...
    if (
      ...
      resultFields.isValid !== true ||
      resultFields.isSnapshotPersistenceCycleRegistryResultContractOnly !==
        true ||
      resultFields.isLiveCall !==
        false ||
      resultFields.canAcceptResult !==
        true ||
      resultFields.canExecuteStorage !==
        false ||
      resultFields.resultSchemaVersion !==
        1 ||
      resultFields.maximumResultBytes !==
        maximumResultBytes ||
      resultFields.maximumCompletedCycleIdentities !==
        maximumCompletedCycleIdentities ||
      resultFields.operation !==
        resultConfig.operation ||
      resultFields.methodName !==
        resultConfig.methodName ||
      resultFields.requiredCapability !==
        resultConfig.requiredCapability ||
      resultFields.storageNamespace !==
        storageNamespace ||
      resultFields.storageKey !==
        storageKey ||
      resultFields.registryIdentity !==
        registryIdentity ||
      resultFields.contractIdentity !==
        (
          "exam_history_persistence_cycle_registry_contract:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.operationPlanIdentity !==
        (
          "exam_history_persistence_cycle_registry_operation_plan:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.operationReleaseIdentity !==
        (
          "exam_history_persistence_cycle_registry_operation_release:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.executionGuardIdentity !==
        (
          "exam_history_persistence_cycle_registry_execution_guard:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.invocationContractIdentity !==
        (
          "exam_history_persistence_cycle_registry_invocation_contract:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.invocationPackageIdentity !==
        (
          "exam_history_persistence_cycle_registry_invocation_package:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.resultContractIdentity !==
        (
          "exam_history_persistence_cycle_registry_result:" +
          resultFields.intent +
          ":v1"
        ) ||
      resultFields.reason !== null
    ) {
      return invalid(
        "persistence_cycle_registry_result_acceptance_result_invalid"
      );
    ...
    const resultReadinessMatch =
      /^exam_history_persistence_cycle_registry_storage_adapter_readiness:v1:read=([01]):write=([01]):delete=([01])$/.exec(
        resultFields.readinessFingerprint
      );

    if (!resultReadinessMatch) {
      return invalid(
    ...
    let acceptedRegistryPayload = null;
    let acceptedRegistryState = null;
    let acceptedCompletedCycleCount =
      null;
    let acceptedSerializedByteLength =
      null;
    ...
    if (
      ...
      if (
        resultFields.canUseRegistry !==
          true ||
        resultFields.didRead !== true ||
        resultFields.didWrite !== false ||
        resultFields.didDelete !== false ||
        resultFields.wasAlreadyAbsent !==
          false ||
        resultFields.isEmpty !== false ||
        resultFields.resultKind !==
          "read_ready" ||
        !Number.isInteger(
          resultFields.completedCycleCount
        ) ||
        resultFields.completedCycleCount <
          0 ||
        resultFields.completedCycleCount >
          maximumCompletedCycleIdentities ||
        !Number.isSafeInteger(
          resultFields.serializedByteLength
        ) ||
        resultFields.serializedByteLength <
          1 ||
        resultFields.serializedByteLength >
          maximumResultBytes ||
        !resultFields.registryState ||
        typeof resultFields.registryState !==
          "object" ||
        Array.isArray(
          resultFields.registryState
        )
      ...
      const payloadState =
        cloneRegistryPayload(
          resultFields.registryPayload
        );

      if (!payloadState.isValid) {
        return invalid(
          "persistence_cycle_registry_result_acceptance_read_payload_invalid"
        );
      }
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_acceptance_read_registry_invalid"
        );
      }
      ...
      acceptedRegistryPayload =
        deserializationState.registryPayload;

      acceptedRegistryState =
        deserializationState.registryState;

      acceptedCompletedCycleCount =
        resultFields.completedCycleCount;

      acceptedSerializedByteLength =
        resultFields.serializedByteLength;
    } else if (
      resultFields.status ===
        "exam_result_history_persistence_cycle_registry_result_read_empty"
      ...
      if (
        resultFields.canUseRegistry !==
          false ||
        resultFields.didRead !== false ||
        resultFields.didWrite !== true ||
        resultFields.didDelete !== false ||
        resultFields.wasAlreadyAbsent !==
          false ||
        resultFields.isEmpty !== false ||
    ...
    const resultAcceptanceIdentity =
      "exam_history_persistence_cycle_registry_result_acceptance:" +
      packageFields.intent +
      ":v1";
    ...
    return createState({
      ...
      readinessFingerprint:
        packageFields.readinessFingerprint,
      didRead:
        resultFields.didRead,
      didWrite:
        resultFields.didWrite,
      didDelete:
        resultFields.didDelete,
      wasAlreadyAbsent:
        resultFields.wasAlreadyAbsent,
      isEmpty:
  ...
  function mapParticipantFullExamResultHistorySnapshotPersistenceCycleRegistryResultContract(input) {
    ...
    const createState = ({
      ...
      status,
      isValid,
      isSnapshotPersistenceCycleRegistryResultContractOnly: true,
      isLiveCall: false,
      canAcceptResult,
      canUseRegistry,
      canExecuteStorage: false,
    ...
    const invalid = (reason) =>
      createState({
        status:
          "exam_result_history_persistence_cycle_registry_result_invalid",
        isValid: false,
    ...
    if (!packageProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_result_package_missing"
      );
    }

    if (!packageProperty.isValid) {
      return invalid(
        "persistence_cycle_registry_result_package_accessor_not_allowed"
      );
    }

    if (!resultProperty.isPresent) {
      return invalid(
        "persistence_cycle_registry_result_value_missing"
      );
    }
    ...
    if (!fieldsState.isValid) {
      return invalid(
        "persistence_cycle_registry_result_package_fields_invalid"
      );
    }
    ...
    if (
      ...
      fields.status !==
        "exam_result_history_persistence_cycle_registry_invocation_package_ready" ||
      fields.isValid !== true ||
      fields.isSnapshotPersistenceCycleRegistryInvocationPackageOnly !==
        true ||
      fields.isLiveCall !== false ||
      fields.canInvokeLater !== true ||
      fields.isInvocationPackageValidated !==
        true ||
      ...
      fields.isMethodReferenceValidated !==
        true ||
      fields.canExecuteStorage !== false ||
      fields.invocationPackageVersion !==
        1 ||
      fields.operation !==
        config.operation ||
      fields.methodName !==
    ...
    if (
      fields.canPackageSave !==
        expectedFlags.save ||
      fields.canPackageLoad !==
        expectedFlags.load ||
      fields.canPackageDelete !==
        expectedFlags.delete
    ) {
      return invalid(
        "persistence_cycle_registry_result_package_flags_invalid"
      );
    }
    ...
    if (!readinessMatch) {
      return invalid(
        "persistence_cycle_registry_result_readiness_invalid"
      );
    }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_result_capability_invalid"
      );
    }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_result_arguments_invalid"
      );
    }
    ...
    if (fields.intent === "save") {
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_save_payload_invalid"
        );
      }
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_save_size_mismatch"
        );
      }
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_save_round_trip_invalid"
        );
      }
      ...
      return invalid(
        "persistence_cycle_registry_result_payload_unexpected"
      );
    }
    ...
    if (fields.intent === "load") {
      ...
      if (
        ...
        return invalid(
          "persistence_cycle_registry_result_read_size_invalid"
        );
      }
    ...
    if (
      ...
      return invalid(
        "persistence_cycle_registry_result_delete_confirmation_invalid"
      );
    }
